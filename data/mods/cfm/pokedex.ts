export const Pokedex: {[speciesid: string]: ModdedSpeciesData} = {
	...
	venomoth: {
		...
		evoLevel: 31,
		eggGroups: ["Bug"],
		cfmMoves: ["bugbuzz", "defog", "gigadrain", "leechlife", "poisonfang", "powder", "quiverdance", "sleeppowder", "sludgewave", "stunspore", "toxic", "uturn"],
	},
	diglett: {
		num: 50,
		name: "Diglett",
	...
	kingdra: {
		...
		cfmMoveSpecialDesc: {"whirlpool": "When used by Kingdra: 120BP, 75% accuracy."},
	},
	phanpy: {
		num: 231,
		name: "Phanpy",
	...
	grumpig: {
		...
		cfmMoveSpecialDesc: {"powergem": "10% chance to lower the target's Sp. Def by 1. Grumpig: boosts the power of all Special moves by 20%."},
	},
	spinda: {
		num: 327,
		name: "Spinda",
	...
	lickilicky: {
		...
		cfmMoveSpecialDesc: {"wish": "Fully compatible with all moves and abilities."},
	},
	rhyperior: {
		num: 464,
		name: "Rhyperior",
	...
	klink: {
		...
		abilities: {0: "Clear Body", 1: "Minus", H: "Technician"},
		heightm: 0.3,
		weightkg: 21,
		levitates: true,
		color: "Gray",
	...
	fomantis: {
		...
		abilities: {0: "Leaf Guard", 1: "Chlorophyll", H: "Aroma Veil"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "Pink",
		evos: ["Lurantis"],
	...
	lurantis: {
		...
		name: "Lurantis",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 110, def: 80, spa: 50, spd: 80, spe: 110},
		abilities: {0: "Leaf Guard", 1: "Chlorophyll", H: "Aroma Veil"},
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
...
Water: Scald`},
	...
	sandaconda: {
		...
		evoLevel: 36,
		eggGroups: ["Field", "Dragon"],
		cfmMoves: ["coil", "drillrun", "glare", "gunkshot", "poisonfang", "poisonjab", "slam", "sludgebomb", "spikes", "stealthrock", "toxic", "venomdrench"],
	},
	cramorant: {
		num: 845,
		name: "Cramorant",
	...
	regieleki: {
		...
		color: "Yellow",
		eggGroups: ["Undiscovered"],
		cfmMoves: ["extremespeed", "flashcannon", "hiddenpower", "lightscreen", "rapidspin", "reflect", "superpower", "thunderbolt", "thundercage", "voltswitch", "volttackle", "zingzap"],
	},
	regidrago: {
		num: 895,
		name: "Regidrago",
		...
		color: "Green",
		eggGroups: ["Undiscovered"],
		cfmMoves: ["crunch", "dragondance", "dragonenergy", "dragonpulse", "earthquake", "fireblast", "firefang", "flamethrower", "hiddenpower", "icefang", "poisonfang", "superpower"],
	},
	glastrier: {
		num: 896,
		name: "Glastrier",
