export const Pokedex: {[speciesid: string]: ModdedSpeciesData} = {
	...
	corsolagalar: {
		...
		abilities: {0: "Static", 1: "Weak Armor", H: "Cursed Body"},
		heightm: 0.6,
		weightkg: 0.5,
		color: "White",
		evos: ["Cursola"],
		eggGroups: ["Water 1", "Water 3"],
		cfmMoves: ["calmmind", "curse", "destinybond", "disable", "hydropump", "lightscreen", "nightshade", "reflect", "shadowball", "stealthrock", "strengthsap", "willowisp"],
	},
	remoraid: {
		num: 223,
		name: "Remoraid",
	...
	registeel: {
		...
		abilities: {0: "Overcoat", H: "Iron Fist"},
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	basculin: {
		...
		types: ["Water"],
		baseStats: {hp: 60, atk: 100, def: 60, spa: 80, spd: 45, spe: 115},
	...
	basculinbluestriped: {
		...
		forme: "Blue-Striped",
		types: ["Water"],
		baseStats: {hp: 60, atk: 80, def: 45, spa: 100, spd: 60, spe: 115},
	...
	stunfiskgalar: {
		...
		color: "Green",
		eggGroups: ["Water 1", "Amorphous"],
		cfmMoves: ["curse", "fissure", "icefang", "ironhead", "snaptrap", "stealthrock", "steelbeam", "stoneedge", "suckerpunch", "takedown", "thunderfang", "yawn"],
	},
	mienfoo: {
		num: 619,
		name: "Mienfoo",
